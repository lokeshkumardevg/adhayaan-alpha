...
import { dashnave } from "../store/slices/dashMenu";
const Dashboard = () => {
  ...
  return (
    <>
      ...
      <div className="dashboard-container" onClick={() => dispatch(dashnave())}>
        {console.log(resData)}
